...
export const CloseAndOther = ({ hoverColor, transformRotate = false }: ICloseAndOther) => {
  return (
    <label
      className={'closeAndOther'}
      style={transformRotate ? { transform: 'rotate(0deg)' } : { transform: 'rotate(-90deg)' }}
    >
      <input className={'checkboxInput'} type='checkbox' />
      <svg viewBox='0 0 100 100'>
        <circle className='circle' cx='50' cy='50' r='30' style={{ fill: hoverColor ?? '' }} />
